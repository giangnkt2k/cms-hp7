export default {
  ...
  'members.buttons.verified.label': 'Verified',
  ...
  'members.verified-user.confirm-message': 'Are you sure to verified this user?',
  ...
  // Order
  'orders.table.actual_amount': 'Actual amount',
  'orders.table.agent': 'Agent',
  'orders.table.amount': 'Amount',
  'orders.table.created_at': 'Created at',
  'orders.table.dieting': 'Dieting',
  'orders.table.fee_rate': 'Fee rate',
  'orders.table.id': 'ID',
  'orders.table.is_resolved': 'Is resolved',
  'orders.table.price': 'Price',
  'orders.table.quantity': 'Quantity',
  'orders.table.real_name': 'Real name',
  'orders.table.remarks': 'Remarks',
  'orders.table.stock_code': 'Stock code',
  'orders.table.stock_market': 'Stock market',
  'orders.table.stock_name': 'Stock name',
  'orders.table.superior': 'Superior',
  'orders.table.trading_session': 'Trading session',
  'orders.table.type': 'Type',
  'orders.table.updated_at': 'Updated at',
  'orders.table.user_id': 'User id',
  'orders.table.username': 'User name',
  'orders.table.zhangting': 'Zhangting',
  // config
  'config.d&w.deposit_min': 'Deposit minimum',
  'config.d&w.deposit_max': 'Deposit maximum',
  'config.d&w.withdrawal_min': 'Withdrawal minimum',
  'config.d&w.withdrawal_max': 'Withdrawal maximum',
  'config.d&w.deposit_permission': 'Deposit permission',
  'config.d&w.withdrawal_permission': 'Withdrawal permission',
  'config.d&w.institutional_code': 'Institutional code',
  'config.d&w.deposit_prompt': 'Deposit prompt',
  'config.d&w.upload_deposit_voucher': 'Upload deposit voucher',
  'config.d&w.transfer_account_detail': 'Transfer account detail',
  'config.d&w.withdrawal_prompt': 'Withdrawal prompt',
  'config.d&w.withdrawal_date_available': 'Withdrawal date available',
  'config.d&w.start_time': 'Start time',
  'config.d&w.end_time': 'End time',
  'config.transactionRate.transaction_fees': 'Transaction fees',
  'config.transactionRate.withdrawal_fees': 'Withdrawal fees',
  'config.transactionRate.min_trans_balance': 'Min transaction balance',
  'config.tradingHour.start_in_the_morning': 'Start in the morning',
  'config.tradingHour.end_of_the_morning': 'End of the morning',
  'config.tradingHour.start_in_the_afternoon': 'Start in the afternoon',
  'config.tradingHour.end_of_the_afternoon': 'End of the afternoon',
  'config.tradingHour.trading': 'Trading',
  'config.newShares.date_new_share': 'Date new share',
  'config.newShares.ipo_signed_on_purchased': 'IPO signed on purchased',
  'config.newShares.ipo_shenzhen': 'IPO shenzhen',
  'config.newShares.ipo_beijing': 'IPO beijing',
  'config.newShares.ipo_app_min': 'IPO app min',
  'config.newShares.ipo_app_max': 'IPO app max',
  'config.newShares.hit_new_min_deposit_require': 'Hit new min deposit require',
  'config.newShares.hit_new_min_deposit_amount': 'Hit new min deposit amount',
  'config.newShares.multi_app': 'Multi app',
  'config.newShares.sufficient_available': 'Sufficient available',
  'config.onlineService.online_customer_service': 'Online customer Service',
  'config.message.error': 'Update config fail',
  'config.message.success': 'Update config success'
